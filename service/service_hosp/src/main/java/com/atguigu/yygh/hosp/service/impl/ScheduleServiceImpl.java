...
import com.atguigu.yygh.common.utils.WeekUtil;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    @Autowired
    private ScheduleRepository schedulRepository;
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        Schedule scheduleExist  =  schedulRepository
        ...
        if(scheduleExist != null){
            ...
            schedulRepository.save(scheduleExist);
        }else{
    ...
    public Page<Schedule> findPageSchedule(int page, int limit, ScheduleQueryVo scheduleQueryVo) {
        ...
        Page<Schedule> all = schedulRepository.findAll(example, pageable);
        return all;
    }
    ...
    public void remove(String hoscode, String hosScheduleId) {
        //根据医院编号和排班编号进行查询
        Schedule schedule = schedulRepository.getScheduleByHoscodeAndHosScheduleId(hoscode, hosScheduleId);

        if(schedule != null){
            //存在则删除
            schedulRepository.deleteById(schedule.getId());
        }
    }
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
        ...
        List<Schedule> scheduleList =
                schedulRepository.findScheduleByHoscodeAndDepcodeAndWorkDate(hoscode,depcode,new DateTime(workDate).toDate());
    ...
    public Schedule getScheduleById(String scheduleId) {
        Schedule schedule = schedulRepository.findById(scheduleId).get();
    ...
    private IPage getListDate(Integer page, Integer limit, BookingRule bookingRule) {
        ...
        //如果当天放好时间已经过期了，预约周期从后一天开始计算，周期加一
